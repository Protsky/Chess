 ...
 *
 * È la stessa macchina che tiene in piedi Frasi (`lingua/assets/js/fsrs.js`),
 * copiata di proposito invece che condivisa: le due app vivranno in repo
 * diversi, e una dipendenza fra loro sarebbe un guaio al primo trasloco.
 * Se una delle due la corregge, la correzione va portata a mano anche nell'altra.
 */
